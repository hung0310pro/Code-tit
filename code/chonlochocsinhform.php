            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <select name="truong" id="truong" class="form-control chosen-select">
                        ...
                        foreach ($danhsachhoso as $value) {
                            ?>
                            <option value="<?= $value["Tdj3ex5_id"];?>" <?php if(isset($_GET['truong']) && ($_GET["truong"] == $value["Tdj3ex5_id"])){ echo 'selected="selected"'; }?>><?= $value["Tdj3ex5_EriRyp"]; ?></option>
                            <?php
                ...
                <div class="col-md-3">
                    ...
                    <select name="chuongtrinh" id="chuongtrinh" class="form-control chosen-select">
                        ...
                        foreach ($danhsachhoso as $value) {
                        ?>
                        <option value="<?= $value["Tpn3b1z_id"]; ?>" <?php if(isset($_GET['chuongtrinh']) && ($_GET["chuongtrinh"] == $value["Tpn3b1z_id"])){ echo 'selected="selected"'; }?>><?= $value["Tpn3b1z_kHDasl"]; ?></option>
                        <?php
                ...
                <div class="col-md-3">
                    ...
                    <select name="trangthai" id="trangthai" class="form-control chosen-select">
                        ...
                        foreach ($danhsachhoso as $value) {
                        ?>
                        <option value="<?= $value["Id"]; ?>" <?php if(isset($_GET['trangthai']) && ($_GET["trangthai"] == $value["Id"])){ echo 'selected="selected"'; }?>><?= $value["Value"]; ?></option>
                        <?php
